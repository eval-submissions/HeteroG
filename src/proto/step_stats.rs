...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04\x01\x02\x01\x12\x03\x16\x02\x18\x1a,\x20These\x20are\x20per-node\
    ...
    \x04\x12\x03/\x02>\n\r\n\x05\x04\x03\x02\x04\x04\x12\x04/\x02.8\n\x0c\n\
    \x05\x04\x03\x02\x04\x05\x12\x03/\x02\x07\n\x0c\n\x05\x04\x03\x02\x04\
    \x01\x12\x03/\x08%\n\x0c\n\x05\x04\x03\x02\x04\x03\x12\x03/()\n\x0c\n\
    \x05\x04\x03\x02\x04\x08\x12\x03/*=\n\r\n\x06\x04\x03\x02\x04\x08\x03\
    \x12\x03/+<\n\x0b\n\x04\x04\x03\x02\x05\x12\x030\x02L\n\x0c\n\x05\x04\
    \x03\x02\x05\x04\x12\x030\x02\n\n\x0c\n\x05\x04\x03\x02\x05\x05\x12\x030\
    \x0b\x10\n\x0c\n\x05\x04\x03\x02\x05\x01\x12\x030\x113\n\x0c\n\x05\x04\
    \x03\x02\x05\x03\x12\x03067\n\x0c\n\x05\x04\x03\x02\x05\x08\x12\x0308K\n\
    \r\n\x06\x04\x03\x02\x05\x08\x03\x12\x0309J\nN\n\x02\x04\x04\x12\x044\0J\
    \x01\x1aB\x20Time/size\x20stats\x20recorded\x20for\x20a\x20single\x20exe\
    cution\x20of\x20a\x20graph\x20node.\n\n\n\n\x03\x04\x04\x01\x12\x034\x08\
    \x15\n\xd8\x01\n\x04\x04\x04\x02\0\x12\x039\x02\x17\x1a\xca\x01\x20TODO(\
    tucker):\x20Use\x20some\x20more\x20compact\x20form\x20of\x20node\x20iden\
    tity\x20than\n\x20the\x20full\x20string\x20name.\x20\x20Either\x20all\
    \x20processes\x20should\x20agree\x20on\x20a\n\x20global\x20id\x20(cost_i\
    d?)\x20for\x20each\x20node,\x20or\x20we\x20should\x20use\x20a\x20hash\
    ...
    \x04\x05\x02\x02\x12\x03P\x02'\x1a\x17\x20Its\x20key\x20is\x20thread\x20\
    id.\n\n\r\n\x05\x04\x05\x02\x02\x04\x12\x04P\x02N(\n\x0c\n\x05\x04\x05\
